...
public class UsersController {
    ...
    private String generarToken(User user) {
        ...
        String token = Jwts.builder().setId("softtekJWT").setSubject(user.getName())
                .claim("role", user.getRole()).claim("username", user.getUsername())
                .claim("name", user.getName()).claim("email", user.getEmail())
